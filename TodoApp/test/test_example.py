...
class Student:
    ...
    def __init__(
        self, first_name: str, last_name: str, major: str, years: int, **kwargs
    ):
...
def test_person_initialization(default_student):
    ...
    assert default_student.major == "CS", "Major should be CS"
    assert default_student.years == 3, "Years should be int of 3"
